 ...
 * 已知任务详情
 */
public class ConfirmTaskDetailActivity extends BaseActivity implements NetIntentCallBackListener.INetIntentCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirm_task_detail);
        ButterKnife.bind(this);
        util = new SharedPreferencesUtil(this);
        Util.setHeadTitleMore(this, "已知任务", true);
        btnSubmit.setText("开始任务");
    ...
    public void onResponse(String response) {
        ...
        try {
            ...
            ToastUtils.showShortToastSafe(ConfirmTaskDetailActivity.this, jsonObject.getString("ErrMsg"));
    ...
    public void onViewClicked() {
        startActivity(new Intent(ConfirmTaskDetailActivity.this, DriverTaskExcuteStatusActivity.class).putExtra("orderId", orderId).putExtra("orderStatue","0"));
        finish();
    }
}